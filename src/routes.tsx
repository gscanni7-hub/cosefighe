...
export const routes: RouteObject[] = [
  {
    ...
    children: [
      ...
      { path: '/mappa', lazy: () => import('./pages/MappaPage').then((m) => ({ Component: m.default })) },
      ...
      // Le stesse pagine in inglese, sotto /en: i componenti leggono la lingua dall'indirizzo.
      { path: '/en', element: <HomePage /> },
      { path: '/en/experiences', element: <ExperiencesPage /> },
      { path: '/en/experiences/:slug', lazy: () => import('./pages/ExperiencePage').then((m) => ({ Component: m.default })) },
      { path: '/en/things-to-do', element: <WhatsOnPage /> },
      { path: '/en/things-to-do/today', element: <WhatsOnPage fixed="oggi" /> },
      { path: '/en/things-to-do/weekend', element: <WhatsOnPage fixed="weekend" /> },
      { path: '/en/map', lazy: () => import('./pages/MappaPage').then((m) => ({ Component: m.default })) },
      { path: '/en/events/:slug', lazy: () => import('./pages/EventPage').then((m) => ({ Component: m.default })) },
      { path: '/en/creators', element: <CreatorPage /> },
      { path: '/en/about', element: <AboutPage /> },
      { path: '/en/contact', element: <ContactPage /> },
      { path: '/en/category/:slug', element: <CategoryPage /> },
      { path: '/en/blog', element: <BlogPage /> },
      { path: '/en/blog/:slug', lazy: () => import('./pages/BlogArticlePage').then((m) => ({ Component: m.default })) },
      { path: '/en/privacy', lazy: () => import('./pages/PrivacyPage').then((m) => ({ Component: m.default })) },
      { path: '/en/cookies', element: <CookiePage /> },
